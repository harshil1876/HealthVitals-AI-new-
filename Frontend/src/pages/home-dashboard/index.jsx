...
const HomeDashboard = () => {
  ...
  useEffect(() => {
    ...
    setNotifications([
      ...
      { id: 2, type: 'achievement', message: 'You reached your daily step goal!' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-background rounded-medical-lg shadow-medical p-6">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="text-sm font-medium text-text-secondary">Today's Summary</span>
              </div>
              <p className="text-2xl font-bold text-text-primary">8 activities</p>
            ...
            <div className="bg-background rounded-medical-lg shadow-medical p-6">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="text-sm font-medium text-text-secondary">Next Reminder</span>
              </div>
            ...
            <div className="bg-background rounded-medical-lg shadow-medical p-6">
              ...
              <p className="text-2xl font-bold text-text-primary">{userData.healthScore}%</p>
            ...
            <div className="bg-background rounded-medical-lg shadow-medical p-6">
              ...
              <p className="text-2xl font-bold text-text-primary">{userData.streak} days</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 p-3 bg-surface-100 rounded-medical">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-text-primary">Evening Medication</p>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-surface-100 rounded-medical">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-text-primary">Water Reminder</p>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-surface-100 rounded-medical">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-text-primary">Bedtime Routine</p>
